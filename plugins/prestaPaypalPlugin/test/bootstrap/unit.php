...
/*
 * This file is part of the prestaUtilsPlugin package.
 * (c) Mikael Randy <mrandy@prestaconcept.net>
 *
 * For the full copyright and license information, please view the LICENSE
 * file that was distributed with this source code.
...
require_once($root_dir . '/test/bootstrap/unit.php');
require_once($plugin_dir . '/prestaUtilsPlugin/lib/class/puSfTest.class.php');
